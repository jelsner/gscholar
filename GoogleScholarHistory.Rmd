...
Compare scholars. How do James Elsner and Sarah Lester compare?
```{r}
...
Get the data from a spreadsheet. It was emailed by Deana Rohlinger on March 2, 2020. I posted it on Google Sheets and added the Department names.
```{r}
